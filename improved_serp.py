...
class ImprovedSerpAnalyzer:
    """
    An improved SERP analyzer that focuses on reliable extraction methods
    and incorporates the lessons learned from debugging.
    """
    ...
    async def search_google(self, query, num_results=6):
        ...
        try:
            # Try direct HTTP request first (most reliable method based on debugging)
            ...
            print("All search methods failed to return results")
            return []
    ...
    async def _search_with_direct_http(self, query, search_url, num_results=6):
        ...
        try:
            ...
            with open("improved_http_response.html", "w", encoding="utf-8") as f:
                f.write(html_content)
            print("Saved HTML to improved_http_response.html for debugging")
    ...
    async def _search_with_crawler(self, query, search_url, num_results=6):
        ...
        try:
            ...
            # Save the HTML for debugging
            with open("improved_crawler_response.html", "w", encoding="utf-8") as f:
                f.write(html_content)
            print("Saved HTML to improved_crawler_response.html for debugging")
    ...
    def _extract_results_from_html(self, html_content, query, num_results=6):
        ...
        try:
            ...
            with open("improved_extracted_results.json", "w", encoding="utf-8") as f:
                json.dump(result_links, f, indent=2, ensure_ascii=False)
            print("Saved results to improved_extracted_results.json")
